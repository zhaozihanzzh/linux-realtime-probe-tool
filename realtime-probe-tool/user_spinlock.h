// https://github.com/karthick18/ticket_spinlock
/*
...
#define __USPIN_LOCK_INITIALIZER { {0} }
...
typedef struct uspinlock uspinlock_t;

static __inline__ void uspin_lock_init(struct uspinlock *lock)
{
    *lock = (struct uspinlock)__USPIN_LOCK_INITIALIZER;
}
 ...
 */
static __inline__ void uspin_lock(struct uspinlock *lock)
{
 ...
 */
static __inline__ void uspin_unlock(struct uspinlock *lock)
{
